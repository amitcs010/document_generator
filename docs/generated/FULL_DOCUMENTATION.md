...
*Generated: 20260414_211155 by RepoMigrator*
...
*Auto-generated by RepoMigrator on 20260414_211155*
...
| `staging/stg_raw_events.sql` | Transforms raw clickstream events from JSON into a deduplicated, distributed table keyed by event_id | spectrum.raw_clickstream | staging.stg_raw_events |
...
| Component | Description | Sources | Targets |
|-----------|-------------|---------|--------|
| `macros/data_quality_checks.py` | Executes automated data quality checks on Redshift post-ETL, logging results and triggering failure alerts | — | — |
